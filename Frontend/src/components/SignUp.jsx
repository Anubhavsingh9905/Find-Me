...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      let response = await axios.post("https://find-me-v4yl.onrender.com/email/register", {username, emailId, password, otp, phoneNumber}, {withCredentials: true});
  ...
  const sendOtp = (e) => {
    ...
    axios.post("https://find-me-v4yl.onrender.com/email/sendOtp", {emailId}).then((data) => {
      console.log(data);
    });
  };
